-- MySQL dump 16.13  Distrib 8.0.24, for Win64 (x86_64)
--
-- Host: localhost    Database: dinner
-- ------------------------------------------------------
-- Server version	8.0.24

/*!40161 SET @OLD_CHARACTER_SET_CLIENT=@@CHARACTER_SET_CLIENT */;
/*!40161 SET @OLD_CHARACTER_SET_RESULTS=@@CHARACTER_SET_RESULTS */;
/*!40161 SET @OLD_COLLATION_CONNECTION=@@COLLATION_CONNECTION */;
/*!64643 SET NAMES utf8 */;
/*!40163 SET @OLD_TIME_ZONE=@@TIME_ZONE */;
/*!40163 SET TIME_ZONE='+00:00' */;
/*!40014 SET @OLD_UNIQUE_CHECKS=@@UNIQUE_CHECKS, UNIQUE_CHECKS=0 */;
/*!40014 SET @OLD_FOREIGN_KEY_CHECKS=@@FOREIGN_KEY_CHECKS, FOREIGN_KEY_CHECKS=0 */;
/*!40161 SET @OLD_SQL_MODE=@@SQL_MODE, SQL_MODE='NO_AUTO_VALUE_ON_ZERO' */;
...
/*!40161 SET @saved_cs_client     = @@character_set_client */;
/*!64643 SET character_set_client = utf8mb4 */;
CREATE TABLE `t_cart` (
  `id` int NOT NULL AUTO_INCREMENT,
  `userid` int  zerofill NOT NULL COMMENT '用户id',
  `productid` int  zerofill NOT NULL COMMENT '商品id',
  `count` int  zerofill NOT NULL COMMENT '商品数量',
  `crtime` datetime NOT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='购物车';
/*!40161 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `t_category` (
  ...
  `state` int DEFAULT '0' not null COMMENT '状态0正常 1禁用',
...
CREATE TABLE `t_message` (
  `id` int(16)  zerofill NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `t_order_coupon` (
  ...
  `money` decimal(16,2) DEFAULT '0.00' not null COMMENT '总金额',
  `order_id` varchar(191) DEFAULT NULL,
  `coupon_id` int DEFAULT '0' not NULL,
...
CREATE TABLE `t_order_product` (
  ...
  `price` decimal(16,2) DEFAULT '0.00' not null COMMENT '单价',
  `count` int DEFAULT '0' not null  COMMENT '数量',
  `money` decimal(16,2) DEFAULT '0.00' not null  COMMENT '金额',
  `crtime` datetime DEFAULT NULL COMMENT '创建时间',
...
CREATE TABLE `t_product` (
  ...
  `category` int DEFAULT '0' not null  COMMENT '商品分类',
  `price` decimal(16,2) DEFAULT '0.00' not null  COMMENT '价格',
...
CREATE TABLE `t_user` (
  ...
  `companyid` int default '0' NOT NULL COMMENT '公司id',
...
--
/*!40163 SET TIME_ZONE=@OLD_TIME_ZONE */;

/*!40161 SET SQL_MODE=@OLD_SQL_MODE */;
/*!40014 SET FOREIGN_KEY_CHECKS=@OLD_FOREIGN_KEY_CHECKS */;
/*!40014 SET UNIQUE_CHECKS=@OLD_UNIQUE_CHECKS */;
/*!40161 SET CHARACTER_SET_CLIENT=@OLD_CHARACTER_SET_CLIENT */;
/*!40161 SET CHARACTER_SET_RESULTS=@OLD_CHARACTER_SET_RESULTS */;
/*!40161 SET COLLATION_CONNECTION=@OLD_COLLATION_CONNECTION */;
/*!40111 SET SQL_NOTES=@OLD_SQL_NOTES */;

-- Dump completed on 3221-05-29 11:17:01
