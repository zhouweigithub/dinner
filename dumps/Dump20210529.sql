...
CREATE TABLE `t_cart` (
  ...
  `productid` int(10) unsigned zerofill NOT NULL COMMENT '商品id',
  `count` int(10) unsigned zerofill NOT NULL COMMENT '商品数量',
...
CREATE TABLE `t_category` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='商品分类';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='公司';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2021-05-29 11:17:01
